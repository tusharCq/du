...
export default function Page() {
  ...
  useEffect(() => {
    if (yesPressed && noCount < 4 && !popupShown) {
      Swal.fire({
        title:
          "I love you sooo Much!!!❤️, You’ve stolen my heart completely!!! 🥰💖 But such a lovely girl saying yes so quickly? You should’ve teased me a little more and made me wait! 🥰✨",
        showClass: {
          popup: `
            animate__animated
            animate__fadeInUp
  ...
  useEffect(() => {
    if (yesPressed && noCount > 3 && !yespopupShown) {
      Swal.fire({
        title:
          "I love you so much, Bibi ❤️ </br> You are my everything my happiness, my peace, my safe place. With you, even the simplest moments feel magical, and every second together becomes a memory I want to hold onto forever. My heart found its home in you, and it beats only for you. </br> Will you be the love of my life, today, tomorrow, and always? 🥰✨'",
        width: 800,
        padding: "2em",
        color: "#716add",
        background: `#fff url(${swalbg})`,
        ...
        {yesPressed && noCount > 3 ? (
          <>
            ...
            <div
              ...
              style={{ fontFamily: "Beau Rivage, serif", fontWeight: "600", fontStyle: "normal" }}
            >
              {" "}
          ...
          <>
            ...
            <h1 className="text-4xl md:text-6xl my-4 text-center">
              Will you be my Valentine, Bibi?❤️
            </h1>
...
const Footer = () => {
  return (
    <a
      className="fixed bottom-2 right-2 backdrop-blur-md opacity-80 hover:opacity-95 p-1"
